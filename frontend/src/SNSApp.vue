            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="projects"
                        to="/projectManagements/projects"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="developerGuides"
                        to="/developmentGuides/developerGuides"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="educations"
                        to="/educationSupports/educations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '프로젝트', 
                description: '자율주행 프로젝트', 
                key: 'projects', 
                route: '/projectManagements/projects',
                ImageUrl: '',
            },
            { 
                title: '개발자 가이드', 
                description: '개발자 코딩 가이드', 
                key: 'developerGuides', 
                route: '/developmentGuides/developerGuides',
                ImageUrl: '',
            },
            { 
                title: '교육', 
                description: '교육 지원', 
                key: 'educations', 
                route: '/educationSupports/educations',
                ImageUrl: '',
            },
